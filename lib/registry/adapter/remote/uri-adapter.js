...
(function(){
  var FileIO, Installer, BaseAdapter, fs, Q, GlobalConfig, gconf, syncRequest, retrieve, RegistryUriAdapter, toString$ = {}.toString;
  ...
  module.exports = RegistryUriAdapter = (function(superclass){
    ...
    function RegistryUriAdapter(options){
      ...
      this.repoType = this.options.repoType || this.defaultRepo();
      this.type = this.options.type || this.defaultType();
    ...
    prototype.defaultInstaller = function(){
      return gconf.get('registry.adapter.installer') || 'file';
    };
    prototype.defaultRepo = function(){
      return gconf.get('registry.adapter.repo') || 'github';
    };
    prototype.repoUri = function(){
      var clazz, repo;
      clazz = this.repoClazz();
      repo = new clazz;
      return repo.registryPath(this.options.repo);
    };
