  ...
  module.exports = BaseAdapter = (function(){
    ...
    function BaseAdapter(options){
      this.options = options != null
        ? options
        : {};
      this.registryUri = this.options.registry || this.defaultRegistryUri();
      this.localRegistryPath = this.options.local || this.defaultComponentsDir();
      this.validate();
      this;
    }
    prototype.defaultComponentsDir = function(){
      return gconf.location('components.dir') || './xlibs/components/';
    };
    prototype.defaultRegistryUri = function(){
      return "https://raw.githubusercontent.com/kristianmandrup/libraries/master/registry";
    };
