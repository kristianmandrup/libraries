...
(function(){
  var FileIO, BaseInstaller, fs, util, path, isBlank, GlobalConfig, gconf, JsonInstaller, toString$ = {}.toString;
  ...
  module.exports = JsonInstaller = (function(superclass){
    ...
    function JsonInstaller(name, source, options){
      ...
      this.options = options != null
        ? options
        : {};
      this.file = this.options.file || this.defaultFile();
      this.configure();
    ...
    prototype.defaultFile = function(){
      return gconf.location('components.json');
    };
    prototype.configure = function(){
      if (!this.exists(this.file)) {
        return this.createComponentsFile();
      }
    };
    prototype.createComponentsFile = function(){
