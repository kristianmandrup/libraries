...
(function(){
  var BaseLoader, FileLoader, JsonLoader, CompositeLoader, Normalizer, GlobalConfig, gconf, LocalLoader;
  ...
  module.exports = LocalLoader = (function(superclass){
    ...
    function LocalLoader(name, options){
      ...
      this.type = this.options.type || 'composite';
      this.component = this.options.component || 'bower';
      this.path = this.options.path || gconf.location('components.dir');
      this.validate();
      this;
    }
    prototype.validate = function(){};
    prototype.loadConfig = function(){
      return this.normalize(this.loadedConfig());
    };
    prototype.hasConfig = function(name){
      name || (name = this.name);
      return this.loader().hasConfig(name);
    };
    ...
    prototype.loadedConfig = function(){
      return this.loader().loadConfig();
    };
    prototype.loader = function(){
      var clazz;
      clazz = this.selectedLoader();
      return new clazz(this.name, this.path, this.options);
    };
    ...
    prototype.badLoader = function(){
      throw new Error("unknown Loader " + this.type);
    };
    return LocalLoader;
  }(BaseLoader));
