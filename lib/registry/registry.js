...
(function(){
  ...
  module.exports = Registry = (function(){
    ...
    prototype.install = function(name){
      var err;
      if (this.exists(this.targetConfig(name))) {
        return;
      }
      try {
        this.installing(name);
        fs.copySync(this.configFile(name), this.targetConfig(name));
        return name;
      } catch (e$) {
        err = e$;
        this.error(err);
    ...
    prototype.installing = function(name){
      return console.log("installing: " + name);
    };
    ...
    prototype.uninstalling = function(name){
      return console.log("uninstalling: " + name);
    };
    return Registry;
  }(FileIO));
