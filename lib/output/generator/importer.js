...
(function(){
  var config, Composite, Directory, Adder, Remover, root, Importer;
  config = {};
  ...
  module.exports = Importer = (function(){
    ...
    function Importer(app, options){
      ...
      this.options = options != null
        ...
        : {};
      this.validate();
      this.file = this.options.file || './' + root + '/libraries.json';
      this.libs();
      this;
    }
    prototype.validate = function(){
    ...
    prototype.configSass = function(){
      if (!this.app.includeSassPath) {
        return this.app.includeSassPath = function(dir){
          return this.options.sassOptions.includePaths.push(dir);
        };
      }
    };
    prototype.addSassPath = function(dir){
      return app.includeSassPath('#{dir}');
    };
    return Importer;
  }(Adder, Remover));
